...
export async function fetchUserThreads(userId: string){
    ...
    try {
        ...
        throw new Error(`Failed to fetch specific Users posts: ${error.message}`)
    }
}
...
export async function fetchUsers({
    ...
    try {
        ...
        const query: FilterQuery<typeof User> = {
            id: { $ne: userId} //not equal to this id/ not yourself
        }
        ...
        // Perfomance can be improved by setting a limit on the exact number of documents
